...
public class AccessBank extends AppCompatActivity {
        ...
        transfer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (amountId.isEmpty()) {
                    ...
                    Intent intent = new HoverParameters.Builder(AccessBank.this)
                            .request("f0e1418a")
                            .extra("amount", amountId)
                            .extra("RecipientAccountNumber", Nuban)
                            .setHeader("Working")
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 0 && resultCode == Activity.RESULT_OK) {
            String[] Transfer = data.getStringArrayExtra("Session Messenger");
            String trans = data.getStringExtra("f0e1418a");
